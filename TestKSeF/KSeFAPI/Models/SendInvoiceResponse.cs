...
{
    /// <summary> The SendInvoiceResponse. </summary>
    public partial class SendInvoiceResponse
    {
        ...
        internal SendInvoiceResponse(DateTimeOffset timestamp, string referenceNumber, int processingCode, string processingDescription, string elementReferenceNumber)
        {
