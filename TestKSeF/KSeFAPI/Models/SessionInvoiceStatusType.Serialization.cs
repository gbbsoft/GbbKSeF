...
namespace KSeFAPI.Models
{
    ...
    {
        internal static SessionInvoiceStatusType DeserializeSessionInvoiceStatusType(JsonElement element)
        {
            ...
            return new SessionInvoiceStatusType(processingCode, processingDescription, elementReferenceNumber, invoiceNumber.Value, ksefReferenceNumber.Value, Optional.ToNullable(acquisitionTimestamp));
        }
    }
}
