...
{
    /// <summary> The StatusCredentialsResponse. </summary>
    public partial class StatusCredentialsResponse
    {
        ...
        internal StatusCredentialsResponse(DateTimeOffset timestamp, string referenceNumber, int processingCode, string processingDescription, string elementReferenceNumber)
        {
