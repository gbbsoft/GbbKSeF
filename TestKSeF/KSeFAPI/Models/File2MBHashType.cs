...
{
    /// <summary> The File2MBHashType. </summary>
    public partial class File2MBHashType
    {
        /// <summary> Initializes a new instance of File2MBHashType. </summary>
        /// <param name="hashSHA"></param>
        /// <param name="fileSize"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="hashSHA"/> is null. </exception>
        public File2MBHashType(HashSHAType hashSHA, int fileSize)
        {
            if (hashSHA == null)
            {
